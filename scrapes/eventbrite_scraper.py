...
cookies = {
    ...
    'SP': 'AGQgbbkap2MNH8dDue9W8Om76RBh8Qe_ctLlqnUnIEw_-maBcehQJ0a7-A-QRo6VA6TLcTMLYt73DDBGReDvWFEtY-CuVe2n5-NO2hleG1mN0GFdnGS7Xd3wnkskTap8GZlWgy2JmoPi-8oLjj7zyIshgZcVeMaNPlypyh7EGEaP8UfppyZ5qP3lUM7lIYlEyDNAAwtipCmudmA872r8OZealeeTb73pASBXWt89Z1HVYSqMvVtnBAQ',
...
headers = {
    ...
    # 'cookie': 'stableId=6f8617a2-14e6-4f02-9411-4173a935953c; guest=identifier%3D7799f31a-2f50-494b-bc7d-ebee43a05cfb%26a%3D13f1%26s%3D63522b5c27a0d78b9d900c01eda083867e3ab8ced28814d7aec5dcf033133b2f; G=v%3D2%26i%3D7799f31a-2f50-494b-bc7d-ebee43a05cfb%26a%3D13f1%26s%3D5db8c90d85a87f2bcbce5375bfe05a4b0eee0c1c; eblang=lo%3Den_US%26la%3Den-us; mgref=eafil; csrftoken=0eaae89e1fa411f0b711ff221839204c; _hp2_props.1404198904=%7B%7D; IR_PI=77be4a34-1705-11f0-88a0-9b6dfbd14725%7C1745344994484; ebEventToTrack=; SS=AE3DLHTguMArw88gNHZxD8zUPqB8SiN6uw; AN=; AS=20750610-7ab6-49ac-8f66-fc591997795c; _gid=GA1.2.1197275584.1762927415; _gcl_au=1.1.419380958.1762927415; IR_gbd=eventbrite.com; __spdt=9b420a15fcb446c290e6a932e9c65551; _tt_enable_cookie=1; _ttp=01K9VAK426NH2G28GYX3G559Y7_.tt.1; _pin_unauth=dWlkPU16RTFNakJtTURBdFlqZzFNUzAwTTJNMkxXSmlNRGd0WWpFMk1tRmhNbVExTmpkbQ; _fbp=fb.1.1762927416660.98732095680540312; _cs_c=0; _hp2_ses_props.1404198904=%7B%22ts%22%3A1762927416826%2C%22d%22%3A%22www.eventbrite.com%22%2C%22h%22%3A%22%2Fd%2Fct--west-haven%2Fevents%2F%22%7D; tcm={"purposes":{"SaleOfInfo":"Auto","Functional":"Auto","Analytics":"Auto","Advertising":"Auto"},"timestamp":"2025-11-12T06:03:35.026Z","confirmed":false,"prompted":false,"updated":false}; __hstc=195498867.5012ca7a00283b1f77042b2faf4dd941.1762927417066.1762927417066.1762927417066.1; hubspotutk=5012ca7a00283b1f77042b2faf4dd941; __hssrc=1; location={%22current_place%22:%22Connecticut%22%2C%22current_place_parent%22:%22U.S.%22%2C%22country%22:%22United%20States%22%2C%22latitude%22:41.580163%2C%22longitude%22:-72.756629%2C%22slug%22:%22united-states--connecticut%22%2C%22place_type%22:%22region%22%2C%22place_id%22:%2285688629%22%2C%22is_online%22:false}; SP=AGQgbbkap2MNH8dDue9W8Om76RBh8Qe_ctLlqnUnIEw_-maBcehQJ0a7-A-QRo6VA6TLcTMLYt73DDBGReDvWFEtY-CuVe2n5-NO2hleG1mN0GFdnGS7Xd3wnkskTap8GZlWgy2JmoPi-8oLjj7zyIshgZcVeMaNPlypyh7EGEaP8UfppyZ5qP3lUM7lIYlEyDNAAwtipCmudmA872r8OZealeeTb73pASBXWt89Z1HVYSqMvVtnBAQ; session=identifier%3D34415c3ee2bc411d8763052e9bd37f12%26issuedTs%3D1762929382%26originalTs%3D1762927413%26s%3Dc8c2ab0171bfa83bf08e04a50a634a41176a69baf45256bb47ebbc9b59093671; _ga_TQVES5V6SH=GS2.1.s1762927416$o1$g1$t1762929385$j58$l0$h0; _ga=GA1.1.1251841201.1762927415; _hp2_id.1404198904=%7B%22userId%22%3A%225836808813787335%22%2C%22pageviewId%22%3A%228022548442199499%22%2C%22sessionId%22%3A%228750206208241354%22%2C%22identity%22%3Anull%2C%22trackerVersion%22%3A%224.0%22%7D; IR_21676=1762929385622%7C0%7C1762929385622%7C%7C; ttcsid_C3DHGPITO1NMNN16MDBG=1762927415370::GaUlWxSi-aeivVpSjh9b.1.1762929385900.0; ttcsid=1762927415370::AuBpczaDH8L6CQ6Mjcl6.1.1762929385900.0; _cs_id=8e2b0543-0636-a6e4-c7b4-69280d1b494a.1762927416.1.1762929386.1762927416.1751381409.1797091416917.1.x; __hssc=195498867.6.1762927417066; _uetsid=5317d600bf8d11f0a1b305a5a360cee6; _uetvid=368fe490a14211ef83dab32e01022cca; _dd_s=rum=0&expire=1762930286876; _cs_s=12.0.U.9.1762931186915',
}
...
# -----------------------------------------------------------------
# STEP 11 & 12: PARSE THE JSON AND SAVE TO CSV
# -----------------------------------------------------------------
...
if response.status_code == 200:
    ...
    # This is the path we found from your JSON!
    event_list = data['events']
    
    # --- NEW ---
    # Create an empty list to store all our event dictionaries
    all_events_data = [] 
    ...
    for event in event_list:
        try:
            ...
            # Combine date and time for our recommendation model
            # This is a crucial step for your database!
            full_datetime = f"{start_date}T{start_time}"

            # Location is nested
            venue = event.get('primary_venue')
            if venue:
                location_name = venue.get('name', 'N/A') # Get venue name if it exists
            ...
            event_data = {
                ...
                "source_site": "Eventbrite" # Good to track where data came from
            }
            ...
            # If any event is missing a field, we'll see this
            print(f"\nWarning: Could not parse an event. Error: {e}\n")

    # -----------------------------------------------------------------
    # STEP 13: SAVE TO PANDAS DATAFRAME AND CSV
    # -----------------------------------------------------------------
